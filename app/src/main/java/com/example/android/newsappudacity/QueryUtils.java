...
public final class QueryUtils {
    ...
    private static String formatDate(String rawDate) {
        ...
        SimpleDateFormat jsonFormatter = new SimpleDateFormat(jsonDatePattern, Locale.GERMAN);
        try {
            Date parsedJsonDate = jsonFormatter.parse(rawDate);
            String finalDatePattern = "dd-MM-yyyy";
            SimpleDateFormat finalDateFormatter = new SimpleDateFormat(finalDatePattern, Locale.GERMAN);
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                News news = new News(title, author, webUrl, sectionName, date);
